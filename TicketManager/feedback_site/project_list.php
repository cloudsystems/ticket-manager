...
<div id="main_container">
		...
		<tr>
			...
			<td nowrap valign="bottom" align="right" width="100%" colspan="2">
				<a href="report_new.php?project_id=<?php echo $_GET['project_id']?>" class="toolbar">
					<img src="images/new_ticket.jpg" align="middle" border="0">&nbsp;
	...
	<div id="sub_container" style="width:100%;">
...
for ($i = 0; $i < sizeof($filter_column_array); $i++) {
	...
	case "status";
		echo '
				<select class="select_header" name="'.$filter_column_array[$i].'" onChange="document.main_form.'.$filter_column_array[$i].'.value=this.options[this.selectedIndex].value; DocumentReload();">
