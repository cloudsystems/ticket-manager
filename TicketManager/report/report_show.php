...
if ($_GET['project_id'] != 1) //El proyecto del listado de incidencias es 1
{
	echo '
			<td nowrap valign="bottom">
...
?>
	...
	<div id="sub_container" >
		...
		<table border="0"  align="center">
			<tr>
				<td>
					<div id="main_subject_container<?php echo $_GET['report_id']?>" ><?php PrintLabel($_GET['project_id'], $_GET['report_id']);?>
