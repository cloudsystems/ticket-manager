 ...
 *
 * Version:	$Id: project_doexport.php,v 1.14 2011/06/19 08:02:55 alex Exp $
 *
 */
session_start();
...
echo 'area_line'.$area_line;
echo 'area_id '.$area_result->fields["area_id"].'<---->';
...
echo 'area_result'.$area_result->fields[0]["area_id"].'---';

echo 'condition_area '.$condition_area.'<---> ';
...
// Get all report
$allsql="SELECT * FROM 
		proj".$selected_project."_report_table
...
$worksheet = $xml->addSheet($project_name);
