...
<div id="main_container">
	...
	<div id="sub_container" ">
		...
		<table border="1" align="center" style="border-collapse: collapse"  cellpadding="2" cellspacing="0">
		<tr>
		...
		<tr>
			...
			<td width="560" class="content" colspan="3">
				<textarea  class="input-form-text-field" name="summary" value="<?php echo $_SESSION[SESSION_PREFIX.'back_array']['summary']?>" maxlength="200"></textarea>
			</td>
		</tr>
		<tr>
			<td width="140" class="prompt">
...
$all_version_sql = "select * from proj_version_table where project_id='".$_GET['project_id']."' order by version_name desc";
