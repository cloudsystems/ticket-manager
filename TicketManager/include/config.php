 ...
 *
 * Version:	$Id: config.php,v 1.55 2011/06/19 08:41:00 alex Exp $
 *
 */
...
//$GLOBALS['BR_dbtype'] = "mysqlt";		// Type of database (postgres, mysqlt, mysqli)
$GLOBALS['BR_dbuser'] = "bbva";			// User name to access the database
$GLOBALS['BR_dbpwd'] = "bbva";		// Database password
 ...
 */
$GLOBALS["SYS_PROJECT_PATH"] = '/workspaces/plataformasdigitales/git/ticket-manager/TicketManager/';

/* The path of URL. if you have to connect to the Bug Tracker by
 * http://192.168.0.1/bug/index.php, you should input "/bug" here. 
 */
//$GLOBALS["SYS_URL_ROOT"] = "/BugTracker";
...
$GLOBALS['type_array'] = array("", "type_bug","type_feature","type_request");
