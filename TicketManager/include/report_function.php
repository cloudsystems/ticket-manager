...
function GetReportOutput($project_id, $report_id, $action)
{
	...
	if ($action == "update") {
		$return_string .= '<textarea class="input-form-text-field" name="summary" maxlength="200" >'.$summary.'</textarea>';		
	} else {
	...
	// �b�W����X����A�A�H�{�������h��X�C�ӵ{���Ӫ� also see
	$seealso="";
