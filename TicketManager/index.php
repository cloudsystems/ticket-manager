					...
					<form name="exportform" >
					 <font color="#42649B"><?php echo "Informes:"?></font>
					    <select name="export" size="1" >
					      <option selected value="/report/project_export_todos_15dias.php?report_time=15">Ultimos 15 dias (xls)</option>
						  <option value="/report/project_export_todos_15dias.php?report_time=30">Ultimos 30 dias (xls)</option>
						  <option value="/report/project_export_todos_15dias.php">Todos (xls)</option>         
					      
					      <option value="/report/project_export_ali.php">Todas (xml)</option>
			     		    </select>
